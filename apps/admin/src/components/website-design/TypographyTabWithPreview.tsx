...
export function TypographyTabWithPreview() {
  ...
  return (
    <DesignFeatureGate tenant={tenant} feature="typography" hasAccess={hasAccess}>
      ...
      <div className="space-y-6">
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Typography Presets</h2>
                      ...
                      <div className="mt-4 space-y-3">
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-3">
                          ...
                          <p
                            ...
                            style={{ fontFamily: config.body.fontFamily }}
                          >
                            This is how your product descriptions and general content will appear
                            using this font combination. The pairing creates visual hierarchy.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="mt-6 flex items-center justify-end gap-3 border-t pt-6">
            {isSaved && (
              <p className="text-sm font-medium text-green-600">✓ Typography saved successfully!</p>
            )}
            <button
              onClick={handleSave}
              disabled={isSaving}
        ...
        <div className="rounded-lg border border-blue-100 bg-blue-50 p-4">
          <h3 className="mb-2 text-sm font-semibold text-blue-900">Typography Best Practices</h3>
          <ul className="space-y-1 text-sm text-blue-800">
            <li>• Heading fonts establish your brand personality and visual identity</li>
            <li>• Body fonts should prioritize readability for long-form content</li>
            <li>• Good font pairings create clear visual hierarchy on your pages</li>
            <li>• All fonts are optimized and cached by Google Fonts for fast loading</li>
            <li>• Preview your selection on different devices before publishing</li>
          </ul>
        </div>

        {/* Font Details */}
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          <h3 className="mb-3 text-sm font-semibold text-gray-900">Selected Font Details</h3>
