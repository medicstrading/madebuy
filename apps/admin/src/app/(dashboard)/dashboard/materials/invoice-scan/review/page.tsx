...
export default function InvoiceReviewPage() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      success(`Successfully created ${result.materialsCreated || itemsToSave.length} materials`)
        ...
        <div className="p-6">
          <div className="mb-4 rounded-lg bg-blue-50 border border-blue-200 p-4">
            <p className="text-sm text-blue-800">
              Review the extracted data below. You can edit any field, choose to create new materials or update existing ones, or skip items entirely.
            </p>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {items.map((item, index) => (
                  <tr key={index} className={item.action === 'skip' ? 'opacity-50' : ''}>
                    ...
                    <td className="px-4 py-4">
                      <input
                        ...
                        onChange={(e) =>
                          updateItem(index, 'parsedQuantity', parseFloat(e.target.value))
                        }
                    ...
                    <td className="px-4 py-4">
                      <input
                        ...
                        onChange={(e) =>
                          updateItem(index, 'parsedPrice', parseFloat(e.target.value))
                        }
          ...
          <div className="mt-6 flex justify-end gap-3">
            ...
            <button
              ...
              disabled={saving || items.filter(i => i.action !== 'skip').length === 0}
