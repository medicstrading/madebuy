...
import { Plus, Tag, Trash2, Edit, ToggleLeft, ToggleRight } from 'lucide-react'
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {discounts.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 mb-4">Create your first discount code to offer special deals to customers.</p>
            <Link
              href="/dashboard/discounts/new"
