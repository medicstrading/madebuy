...
export default function LandingPage() {
  ...
  const organizationSchema = {
    ...
    description:
      'Australian handmade marketplace connecting makers with buyers. Zero transaction fees, beautiful storefronts.',
    sameAs: ['https://instagram.com/madebuy', 'https://facebook.com/madebuy'],
    contactPoint: {
      '@type': 'ContactPoint',
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FFFBF7] font-outfit overflow-x-hidden">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-gray-900 leading-[1.1] mb-10 tracking-tight">
                ...
                <span className="relative inline-block animate-fade-up-3">
                  <span className="relative z-10 bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent animate-glow">
                    — simplified.
                  </span>
                  <svg
                  ...
                  >
                    <path
                      ...
                      d="M0,8 Q40,2 80,8 T160,6 T200,8"
                      fill="none"
                      stroke="#FCD34D"
                      strokeWidth="5"
                      strokeLinecap="round"
              ...
              <p className="text-xl lg:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-up-4">
                Inventory, media storage, social scheduling, and marketplace
                selling — all in one place.
              </p>
                      ...
                      <div className="bg-white rounded-xl border border-gray-100 p-4">
                        ...
                        <div className="space-y-2">
                          {[
                            ...
                            <div
                              key={product.name}
                              className={`flex items-center gap-3 p-2 rounded-lg ${product.status === 'Low Stock' ? 'bg-amber-50/50' : 'bg-gray-50'}`}
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2">
                                  <span
                                    className={`text-xs px-1.5 py-0.5 rounded ${product.status === 'Low Stock' ? 'bg-amber-100 text-amber-700' : 'bg-emerald-100 text-emerald-700'}`}
                                  >
                                    {product.status}
                                  </span>
                                  <span className="text-xs text-gray-400">
                              ...
                              <p
                                className={`font-bold text-sm ${product.marginColor}`}
                              >
                                {product.margin}
                              </p>
                            </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-100 p-4">
                        ...
                        <div className="space-y-2">
                          {[
                            ...
                            >
                              <div
                                className={`w-8 h-8 rounded-lg ${post.color} flex items-center justify-center`}
                              >
                                <post.icon />
                              </div>
                              ...
                              <span
                                className={`text-xs px-2 py-0.5 rounded-full ${post.status === 'scheduled' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'}`}
                              >
                                {post.status}
                              </span>
                            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                One login. Everything connected. Your photos, videos, products,
                and social posts — all in sync.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="relative bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 border border-emerald-100 overflow-hidden group">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6">
                    Design your own storefront with drag-and-drop ease. No
                    coding needed. Bring your own domain.
                  </p>
                  <div className="flex items-center gap-3">
              ...
              <div className="relative bg-gradient-to-br from-violet-50 to-purple-50 rounded-3xl p-8 border border-violet-100 overflow-hidden group">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6">
                    Store all your product photos and videos. Organize, tag, and
                    reuse across listings and posts.
                  </p>
                  <div className="flex items-center gap-3">
              ...
              <div className="relative bg-gradient-to-br from-pink-50 to-rose-50 rounded-3xl p-8 border border-pink-100 overflow-hidden group">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6">
                    Schedule posts to all platforms. AI writes captions in your
                    voice. A week in 10 minutes.
                  </p>
                  <div className="flex items-center gap-2 flex-wrap">
                    {[
                      ...
                      <div
                        key={i}
                        className="w-7 h-7 rounded-lg bg-white/80 border border-pink-100 flex items-center justify-center text-gray-500"
                      >
                        <Icon />
                      </div>
                    ))}
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border border-blue-100 overflow-hidden group">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6">
                    Sync products to Etsy & eBay. Manage inventory from one
                    dashboard. Never oversell.
                  </p>
                  <div className="flex items-center gap-3">
        ...
        <section
          id="integrations"
          className="py-20 lg:py-28 bg-gradient-to-b from-gray-900 to-gray-950 text-white relative overflow-hidden"
        >
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div>
                ...
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Upload your product photos and videos once. Our AI writes
                  captions that sound like you. Schedule posts across Instagram,
                  TikTok, Facebook, YouTube, Pinterest, and Twitter — all from
                  one screen.
                </p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Learns your style. Never sounds robotic.',
                    },
                    {
                      title: 'Optimal posting times',
                      desc: 'AI picks when your audience is most active.',
                    },
                    {
                      title: 'Video & photo support',
                      desc: 'Reels, Stories, TikToks, Pins — we handle it all.',
                    },
                    {
                      title: 'A week of content in minutes',
                      desc: 'Batch create. Schedule. Forget about it.',
                    },
                  ].map((item) => (
                ...
                <div className="bg-gray-800/50 rounded-3xl p-6 lg:p-8 border border-gray-700/50 backdrop-blur-sm">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      >
                        <div
                          className={`w-10 h-10 rounded-xl bg-gradient-to-br ${platform.color} flex items-center justify-center mb-3 text-white group-hover:scale-110 transition-transform`}
                        >
                          <platform.icon />
                        </div>
                        ...
                        <p
                          className={`text-xs ${platform.connected ? 'text-emerald-400' : 'text-gray-500'}`}
                        >
                          {platform.connected && (
                  ...
                  <div className="bg-gradient-to-br from-violet-900/50 to-purple-900/50 rounded-2xl p-5 border border-violet-700/30">
                    ...
                    <div className="bg-gray-900/50 rounded-xl p-4 border border-violet-800/30">
                      <p className="text-gray-300 text-sm leading-relaxed">
                        &ldquo;New drop alert! 🎨 This hand-thrown ceramic mug
                        took 3 weeks to perfect. Every swirl is unique — just
                        like you. Link in bio to grab yours before they&apos;re
                        gone!&rdquo;
                      </p>
                      <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-800">
                        <span className="text-xs text-violet-400">
                          #handmade #ceramics #smallbusiness
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        ...
                        className={`${marketplace.color} rounded-2xl p-5 border`}
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-10 h-10 rounded-xl bg-white flex items-center justify-center ${marketplace.textColor}`}
                            >
                              <marketplace.icon />
                            </div>
                            <div>
                  ...
                  <div className="mt-6 bg-gray-50 rounded-xl p-4 flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">
                        Inventory auto-synced
                      </p>
                      <p className="text-sm text-gray-500">
                        Stock levels updated across all platforms
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Connect your marketplace accounts and manage everything from
                  one dashboard. Create a listing once — push it everywhere.
                  Update stock in one place — it syncs automatically.
                </p>
        ...
        <section id="features" className="py-20 lg:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Not a generic e-commerce tool. Designed around how handmade
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Track materials, costs, and margins per product. See what
                      you&apos;re actually making — not just what you&apos;re
                      selling.
                    </p>
              ...
              <div className="group bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 lg:p-10 border border-amber-100 hover:shadow-xl hover:shadow-amber-100/50 transition-all duration-300">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Track inventory, costs per unit, supplier info. Get
              ...
              <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 lg:p-10 border border-blue-100 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Snap a photo of supplier invoices. AI extracts materials,
                      quantities, and costs automatically. No manual data entry.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {['AI extraction', 'Auto-import', 'Cost tracking'].map(
                        (tag) => (
                          <span
                            key={tag}
              ...
              <div className="group bg-gradient-to-br from-rose-50 to-pink-50 rounded-3xl p-8 lg:p-10 border border-rose-100 hover:shadow-xl hover:shadow-rose-100/50 transition-all duration-300">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Not a generic e-commerce tool. Designed around how
                      handmade businesses actually work — from one-of-a-kind
                      pieces to custom orders.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {['Custom orders', 'Variations', 'OOAK tracking'].map(
                        (tag) => (
                          <span
                            key={tag}
        ...
        <section className="py-20 lg:py-28 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              Products, social media, marketplaces, and real profit numbers —
              all connected. Finally.
            </p>
            <Link
              href="/auth/signup"
        ...
        <footer className="bg-gray-900 text-gray-400 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8 lg:gap-12 mb-12">
              <div className="md:col-span-1">
                ...
                <p className="text-sm leading-relaxed mb-4">
                  The all-in-one platform for makers. Inventory, social media,
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-sm">
                © {new Date().getFullYear()} MadeBuy. Made with love in
                Australia.
              </p>
